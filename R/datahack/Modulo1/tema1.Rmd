...
La función `complete.cases()` devuelve un vector l?gico que indica los casos completos.
...
## más opciones gr?ficas

**Varios conjuntos de datos en un s?lo gráfico**
...
**Varios gráficos en un s?la imagen**
...
Resulta más intereseante mostrar la informaci?n por g?nero `Gender` y `Dept` combinados (dimensiones 2 y 3 del array). N?tese que las tasas de admisión por `male` y `female` son más o menos similares en todos los departamentos, excepto en "A", donde las tasas de las mujeres es mayor.
